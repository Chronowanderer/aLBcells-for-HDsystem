...
if Operation_Niflheim
    ...
    Trajectory_real_1 = Data.HD((initiation + 1) : (initiation + round(T_len / 2)))';
    Trajectory_real_2 = zeros(1, round(T_len / 2));
    for j = 1 : round(T_len / 2)
        Trajectory_real_2(j) = AngularDiff(Trajectory_real_1(j), Trajectory_real_1(1) - Trajectory_real_1(round(T_len / 2)));
    end
    Trajectory_real = [Trajectory_real_1, Trajectory_real_2];
